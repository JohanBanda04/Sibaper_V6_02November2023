...
$query_old2 = mysqli_query($koneksi,"select stokbarang.sisa-(select sum(sementara.jumlah) 
from (sementara inner join stokbarang 
on sementara.kode_brg=stokbarang.kode_brg) where sementara.status_acc in ('Permintaan Baru', 'Pengajuan Kasub', 'setuju', 
'Pengajuan Bendahara', 'Pengajuan Kasub Bendahara',   
'Penyerahan Barang Ke Pengguna', 'Penerimaan Barang Dari Bendahara') 
...
from (sementara inner join stokbarang 
on sementara.kode_brg=stokbarang.kode_brg) where sementara.status_acc IN ('Permintaan Baru',
'setuju',
'Pengajuan Bendahara',
'Pengajuan Kasub Bendahara',
'Pengajuan Kasub') 
and sementara.kode_brg='$kode_brg' ) as sisa_dummy,kode_brg, stok 
from stokbarang where stokbarang.kode_brg='$kode_brg'");
