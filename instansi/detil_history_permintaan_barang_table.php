...
('Permintaan Baru','Pengajuan Kasub','Tidak Setuju Kasub Bendahara'))");
    ...
    if(isset($_GET['kode_brg_lengkap'])){
        ...
        if($_GET['kode_brg_lengkap']!=""){
            //echo "<br> get kode barang ada isinya :".$_GET['kode_brg_lengkap']."<br>";
            $query_get_penerimaan_dari_bendahara_other_session = mysqli_query($koneksi, "select sementara.bendahara,sementara.bendahara_id,sementara.id_sementara
,stokbarang.nama_brg,stokbarang.satuan,sementara.jumlah,sementara.note_kasub_pengguna,sementara.note_bendahara,
sementara.status_acc, sementara.unit, sementara.user_id,sementara.kode_brg, sementara.tgl_permintaan
from (sementara inner join stokbarang 
on sementara.kode_brg=stokbarang.kode_brg) where unit='$unit' 
and user_id='$user_id' and tgl_permintaan='$tgl_permintaan' and stokbarang.kode_brg='$_GET[kode_brg_lengkap]' 
and status_acc in
('Penerimaan Barang Dari Bendahara')");

            $query_get_selesai_dari_bendahara_other_session = mysqli_query($koneksi, "select sementara.bendahara,sementara.bendahara_id,sementara.id_sementara
,stokbarang.nama_brg,stokbarang.satuan,sementara.jumlah,sementara.note_kasub_pengguna,sementara.note_bendahara,
sementara.status_acc, sementara.unit, sementara.user_id,sementara.kode_brg, sementara.tgl_permintaan
from (sementara inner join stokbarang 
on sementara.kode_brg=stokbarang.kode_brg) where unit='$unit' 
...
//    echo "jml ".$jml_request."<br>";
//    echo mysqli_num_rows($query_get_penerimaan_dari_bendahara_other_session)."<br>";
//    echo mysqli_num_rows($query_get_selesai_dari_bendahara_other_session)."<br>";

    $cek_selesai_semua_kah = array();
    while($data = mysqli_fetch_array($query_get_selesai_dari_bendahara_other_session)){
        //echo $data['status_acc'].'<br>';
        if($data['status_acc']=='Selesai'){
            array_push($cek_selesai_semua_kah);
        }
    }
//die;
    //echo "penerimaan barang dari bendahara ".mysqli_num_rows($query_get_penerimaan_dari_bendahara_other_session);

    if (($jml_akumulasi == $jml_request) || (mysqli_num_rows($query_get_selesai_dari_bendahara_other_session)+mysqli_num_rows($query_get_penerimaan_dari_bendahara_other_session))==$jml_request) {
        //echo "kirim email<br>";
...
where id_subbidang='$subbidang_id_pemohon'");
            ...
            $mail->MsgHTML("Halo, $nama_lengkap_pengelola " . $jabatan_pengelola." " .$nama_bidang_pengelola
                . ", Terdapat Konfirmasi Penerimaan Barang Oleh Pemohon Barang : "
