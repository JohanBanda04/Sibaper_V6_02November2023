...
-- ----------------------------
INSERT INTO `pengeluaran` VALUES (84, 'wika', 50, '000002', 3, '2023-11-01', 491);
INSERT INTO `pengeluaran` VALUES (85, 'wika', 50, '000002', 1, '2023-11-01', 492);
...
) ENGINE = MyISAM AUTO_INCREMENT = 386 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permintaan
-- ----------------------------
INSERT INTO `permintaan` VALUES (385, 'wika', 50, 'pengguna', '000002', 1, 1, '2023-11-01', 1, 492);
INSERT INTO `permintaan` VALUES (384, 'wika', 50, 'pengguna', '000002', 1, 3, '2023-11-01', 1, 491);
...
) ENGINE = MyISAM AUTO_INCREMENT = 493 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sementara
-- ----------------------------
INSERT INTO `sementara` VALUES (492, 'wika', 50, 'pengguna', '000002', 1, 1, '2023-11-01', 'Penerimaan Barang Dari Bendahara', 0, 0, 1, 11, 'abdul2', 54, NULL, NULL, NULL, '', '');
INSERT INTO `sementara` VALUES (491, 'wika', 50, 'pengguna', '000002', 1, 3, '2023-11-01', 'Penerimaan Barang Dari Bendahara', 0, 0, 1, 11, 'abdul2', 54, NULL, NULL, NULL, '', '');
...
-- ----------------------------
INSERT INTO `stokbarang` VALUES (75, '000002', 54, 'abdul2', 1, 'BOLPOINT SNOWMAN V-1', '22000', 'BH', 20, 4, 16, '', '2023-10-02');
