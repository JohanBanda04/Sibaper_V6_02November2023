...
-- ----------------------------
INSERT INTO `pengeluaran` VALUES (91, 'wika', 50, '000002', 2, '2023-11-02', 511);
INSERT INTO `pengeluaran` VALUES (92, 'wika', 50, '000004', 1, '2023-11-02', 512);
...
) ENGINE = MyISAM AUTO_INCREMENT = 397 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permintaan
-- ----------------------------
INSERT INTO `permintaan` VALUES (396, 'wika', 50, 'pengguna', '000004', 1, 1, '2023-11-02', 1, 512);
INSERT INTO `permintaan` VALUES (395, 'wika', 50, 'pengguna', '000002', 1, 2, '2023-11-02', 1, 511);
...
CREATE TABLE `sementara`  (
  ...
  `sesi_email` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_sementara`) USING BTREE,
  INDEX `id_subbidang`(`id_subbidang`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 513 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sementara
-- ----------------------------
INSERT INTO `sementara` VALUES (511, 'wika', 50, 'pengguna', '000002', 1, 2, '2023-11-02', 'Selesai', 0, 0, 1, 11, 'abdul2', 54, NULL, NULL, NULL, 'assets/file/WhatsApp Image 2023-10-05 at 08.01.33.jpeg', '');
INSERT INTO `sementara` VALUES (512, 'wika', 50, 'pengguna', '000004', 1, 1, '2023-11-02', 'Selesai', 0, 0, 1, 11, 'abdul2', 54, NULL, NULL, NULL, 'assets/file/WhatsApp Image 2023-10-18 at 10.40.33.jpeg', '');
...
-- ----------------------------
INSERT INTO `stokbarang` VALUES (75, '000002', 54, 'abdul2', 1, 'BOLPOINT SNOWMAN V-1', '22000', 'BH', 20, 2, 18, '', '2023-10-02');
INSERT INTO `stokbarang` VALUES (76, '000004', 54, 'abdul2', 1, 'BOLPOINT BALLINER HITAM', '245000', 'BH', 20, 1, 19, '', '2023-10-02');
